...
/**
 * This object is used to process the output generated by
 * the program and calculate the precision and recall of
 * the attacks performed. The output is a map which is then
